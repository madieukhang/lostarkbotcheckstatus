...
const en = {
  ...
  autoCheckWelcome: {
    ...
    description: [
      'Drop up to 3 screenshots in one message, or type `check NameOne NameTwo` / `check NameOne, NameTwo` - I read up to 8 character names per image and cross-check them against this server\'s lists.',
      '',
    ...
    howValue: [
      '1. I post a status card immediately, react with 🔍, then read up to 3 images one by one (8 names each, 24 total).',
    ...
    listsName: '📚 The four lists',
    listsValue: [
      '⛔ **Blacklist** - flagged players; treat with caution.',
      '⚠️ **Watchlist** - worth keeping an eye on, not confirmed.',
      '✅ **Whitelist** - vouched, known-good.',
      '🛡️ **Trusted** - verified trusted records.',
      'Black and watch hits deserve your attention; white and trusted give you the matching context.',
    ],
    scopeName: '🌐 Global vs server lists',
    scopeValue: [
    ...
    cleanupDisabledValue: [
      'Auto-cleanup is off here - I only process check requests and never delete ordinary messages.',
      'A Manage Server admin can turn it on with `/la-setup config action:cleanup-on`.',
    ],
    quickAddName: '⚡ Quick Add & officer tools',
    quickAddValue: [
      '• **Quick Add** - after a check, officers get a dropdown to file any unlisted name into a list.',
      '• `/la-evidence name:<character> public:true` - post evidence publicly (officers/seniors).',
      '• `/la-roster name:<character> deep:true` - Stronghold alt scan (officers/seniors).',
    ],
