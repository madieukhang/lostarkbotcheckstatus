export default {
  ...
  check: {
    ...
    }, imageQueued: 'Screenshot check queued · **{count}** image request(s) ahead…', imageProgress: 'Images received · reading **{current}/{count}**…', imageIgnored: 'Each check handles up to {limit} images, so I skipped **{count}** extra.', partialImages: { title: 'Some images could not be read', description: 'I skipped **{failed}/{count}** image(s) after OCR errors. The result above uses only the images that succeeded.', footer: 'You can post the failed image again on its own.' }, ignored: 'I skipped **{count}** extra {word} - I can only take {limit} at a time.', nameOne: 'name', nameMany: 'names',
