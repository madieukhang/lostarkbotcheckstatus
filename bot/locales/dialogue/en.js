export default {
  ...
  setup: {
    ...
    autoCleanup: {
      enabled: 'Auto-cleanup is **enabled for this server only**. At 00:00 Asia/Ho_Chi_Minh, non-pinned messages in its auto-check channel may be deleted. Use `/la-setup cleanup state:off` to stop it.',
      disabled: 'Auto-cleanup is **off for this server**. Auto-check remains active, but LoaLogs will not delete ordinary messages. Use `/la-setup cleanup state:on` to opt in.',
      noChannel: 'Set an auto-check channel with `/la-setup autochannel` before enabling cleanup.',
