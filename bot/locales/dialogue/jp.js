export default {
  ...
  check: {
    ...
    }, imageQueued: '画像 check を順番待ちに入れましたわ · 前に **{count}** 件ございますの…', imageProgress: '画像を受け取りましたわ · **{current}/{count}** 枚目を読み取り中ですの…', imageIgnored: '一度に処理できるのは {limit} 枚までですので、あふれた **{count}** 枚は見送りましたわ。', partialImages: { title: '一部の画像を読み取れませんでしたの', description: 'OCR error のため **{failed}/{count}** 枚を見送りましたわ。上の結果は、読み取りに成功した画像だけを使っておりますの。', footer: '失敗した画像だけ、あとでもう一度お送りいただけますわ。' }, ignored: '一度にお預かりできるのは {limit} 名までですので、あふれた **{count}** 名は見送りましたわ。', nameOne: 'name', nameMany: 'names', failed: { title: '確認が最後まで終わりませんでしたの', description: '画像から名前は読み取れましたけれど、list との照合を最後まで終えられませんでしたわ。' }, autoFailed: { title: 'その確認を終えられませんでしたの', description: '途中でつまずいてしまいましたの。もう一度貼っていただければ、また見てみますわ。' },
    embed: { imageAuthor: '送ってくれた画像から読み取ったリストだよ。', textAuthor: '送ってくれた名前をもとに確認したリストだよ。', autoKicker: 'AUTO-CHECK', slashKicker: 'LIST CHECK', names: 'NAMES', notListed: '未登録', configured: 'configured', ignored: '上限 {limit} のため {count} {word}を除外しましたの。', unverified: '未確認 candidate {count} 件を除外し、Quick Add を無効にしましたの。', flagged: 'FLAGGED {count}', clear: 'CLEAR', elapsed: '⏱️ 解析 {seconds}s', elapsedQuick: { variants: [
        ...
        '⏱️ {seconds}s、全部の名前を照合しましたの。',
        '⏱️ {seconds}s。念入りに見た甲斐がありますわ。',
      ] }, elapsedSlow: { variants: [
        '⏱️ {seconds}s もお待たせしてごめんなさい。名前が多くて時間がかかりましたの。',
