export default {
  ...
  approval: {
    ...
    flow: {
      ...
      compareRaid: 'Raid', compareAdded: '追加日時', compareBy: '申請者',
  ...
  remove: {
    ...
    line: { variants: [
      '{name} を削除しましたわ。古い理由は下に控えておきましたの、また必要になるかもしれませんから。',
      '完了ですわ。{name} は list から消えました。理由はここに残しておきますの。',
      '{name} を削除しましたわ。database にはもう何も残っていませんので、控えを下に置いておきますの。',
    ] },
    lineNoReason: { variants: [
      '{name} を削除しましたわ。その entry には理由がなかったので、残すものがありませんの。',
      '完了ですわ。{name} は list から消えました。',
    ] },
