export default {
  ...
  check: {
    ...
    }, imageQueued: '画像 check を順番待ちに入れましたわ · 前に **{count}** 件ございますの…', imageProgress: '画像を受け取りましたわ · **{current}/{count}** 枚目を読み取り中ですの…', imageIgnored: '一度に処理できるのは {limit} 枚までですので、あふれた **{count}** 枚は見送りましたわ。', ignored: '一度にお預かりできるのは {limit} 名までですので、あふれた **{count}** 名は見送りましたわ。', nameOne: 'name', nameMany: 'names', failed: { title: '確認が最後まで終わりませんでしたの', description: '画像から名前は読み取れましたけれど、list との照合を最後まで終えられませんでしたわ。' }, autoFailed: { title: 'その確認を終えられませんでしたの', description: '途中でつまずいてしまいましたの。もう一度貼っていただければ、また見てみますわ。' },
