export default {
  ...
  search: {
    ...
    title: 'Tìm kiếm · "{name}"', via: 'via **{name}** · ', noReason: 'chưa có lý do', clean: 'sạch', summary: 'Tìm thấy **{count}** {word}: {breakdown}', summaryPlain: 'Tìm thấy **{count}** {word}', matchOne: 'kết quả', matchMany: 'kết quả', footer: 'Bộ lọc: {filters} · Nguồn: lostark.bible',
