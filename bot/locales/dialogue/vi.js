export default {
  common: {
    ...
    wrongTextChannel: {
      ...
      description: 'Cậu chọn một **text channel** để tớ có thể đọc và trả lời nhé.',
    },
    missingPermissions: {
      title: 'Còn thiếu vài quyền',
      description: 'Tớ chưa thể hoàn tất thiết lập <#{channel}> cho đến khi tớ có các quyền bên dưới.',
  ...
  setup: {
    ...
    welcomeCreateFailed: 'Tớ chưa ghim được bảng hướng dẫn mới, và hiện không có ghim Artist cũ để giữ lại.',
    ...
    actions: {
      ...
      setNotifyChannel: 'Đặt channel thông báo',
      setLanguage: 'Đặt ngôn ngữ public',
  ...
  broadcast: {
    ...
    fields: { reason: 'Lý do', raid: 'Raid', edited: 'Đã sửa', added: 'Đã thêm', itemLevel: 'ilvl', combatPower: 'CP', trackedAlts: 'Alt đang track', trackedRosters: 'Danh sách roster', newAlts: 'Alt mới' },
  ...
  approval: {
    ...
    flow: {
      ...
      compareRaid: 'Raid', compareAdded: 'Đã thêm', compareBy: 'Bởi',
  ...
  listEdit: {
    ...
    change: { reason: '📝 **Lý do:** `{old}` → `{next}`', list: '📒 **List:** `{old}` → `{next}`', raid: '🗡️ **Raid:** `{old}` → `{next}`', logs: '🔗 **Logs:** đã cập nhật', evidence: '📎 **Evidence:** đã cập nhật', scope: '🌐 **Scope:** `{old}` → `{next}`', append: 'Thêm alt: {names}', appendWithDuplicates: 'Thêm alt: {names} (bỏ qua tên trùng: {duplicates})' },
  ...
  remove: {
    ...
    line: { variants: [
      'Gỡ {name} rồi nhé. Tớ chép lại lý do cũ ở dưới, phòng khi cậu cần nó lần nữa.',
      'Xong, {name} biến khỏi list rồi. Lý do cũ tớ giữ lại ngay dưới đây.',
      'Đã gỡ {name}. Sau tin này thì database không còn gì về entry đó, nên tớ để lại bản chép ở dưới.',
    ] },
    lineNoReason: { variants: [
      'Gỡ {name} rồi nhé. Entry đó không ghi lý do nên tớ chẳng có gì để giữ lại.',
      'Xong, {name} biến khỏi list rồi.',
    ] },
  ...
  check: {
    ...
    details: { title: 'Kết quả kiểm tra · {list}', headline: '{icon} {name} hiện nằm trong **{list}**{scope}. Tớ gom hết những gì đang lưu về người này ở ngay dưới đây.', headlineVia: '{icon} {searched} chung roster với {name}, và người này đang nằm trong **{list}**{scope}. Đây là tất cả những gì tớ đang lưu.' },
    ...
    }, imageQueued: 'Đã xếp lượt xử lý ảnh · còn **{count}** lượt phía trước…', imageProgress: 'Đã nhận ảnh · đang đọc **{current}/{count}**…', imageCooldownWait: 'Gemini đang tạm nghỉ sau lỗi API · tớ sẽ thử lại ảnh **{current}/{count}** sau **{seconds}s**…', imageIgnored: 'Mỗi lượt xử lý tối đa {limit} ảnh, nên tớ bỏ qua **{count}** ảnh dư.', partialImages: { title: 'Một phần ảnh chưa đọc được', description: 'Tớ bỏ qua **{failed}/{count}** ảnh gặp lỗi OCR. Kết quả bên trên chỉ dựa trên những ảnh đọc thành công.', footer: 'Cậu có thể gửi lại riêng ảnh bị lỗi sau.' }, ignored: 'Tớ bỏ qua **{count}** {word} dư rồi - mỗi lượt tớ chỉ nhận được {limit} thôi.', nameOne: 'tên', nameMany: 'tên', failed: { title: 'Lượt check chưa xong được', description: 'Tớ lấy được tên ra khỏi ảnh rồi, nhưng đối chiếu với các list thì chưa xong.' }, autoFailed: { title: 'Tớ chưa check xong được cái này', description: 'Nửa chừng thì có gì đó trục trặc. Cậu đăng lại ảnh nhé, tớ thử lần nữa.' },
    embed: { imageAuthor: 'Danh sách chụp dựa trên ảnh cậu gửi nè.', textAuthor: 'Danh sách kiểm tra dựa trên tên cậu gửi nè.', autoKicker: 'AUTO-CHECK', slashKicker: 'KIỂM TRA LIST', names: 'TÊN', notListed: 'chưa vào list', configured: 'đã cấu hình', ignored: 'Đã bỏ qua {count} {word} dư (giới hạn: {limit}).', unverified: 'Đã bỏ qua {count} candidate chưa xác minh; không mở Quick Add cho các tên này.', flagged: 'CẦN CHÚ Ý {count}', clear: 'AN TOÀN', elapsed: '⏱️ PHÂN TÍCH {seconds}s', elapsedQuick: { variants: [
        '⏱️ Đọc xong trong {seconds}s, ảnh này rõ nét ghê~',
        '⏱️ Có {seconds}s thôi. Cậu chụp khéo nên tớ đọc nhanh lắm.',
        '⏱️ {seconds}s là xong. Nhẹ nhàng~',
      ] }, elapsedSteady: { variants: [
        '⏱️ Tớ ngẫm hết {seconds}s mới dám chắc.',
        '⏱️ Mất {seconds}s để đối chiếu cho kỹ nhé.',
        '⏱️ {seconds}s, soi từng tên một rồi đấy.',
      ] }, elapsedSlow: { variants: [
        '⏱️ Hết những {seconds}s, xin lỗi để cậu chờ. Ảnh đông tên quá nên tớ đọc chậm.',
        '⏱️ {seconds}s cơ. Tớ không dám đoán bừa nên soi kỹ từng cái tên.',
        '⏱️ Lâu thật, {seconds}s. Bù lại thì tớ chắc chắn không nhầm tên nào.',
      ] }, correctedOcr: 'OCR đã hiệu chỉnh {count} tên · đối chiếu lại với ảnh', correctedText: 'Đã hiệu chỉnh {count} tên nhập · đối chiếu lại tên gốc', quickFlagged: 'Quick Add tên chưa vào list bằng dropdown · /la-roster <name> để xem kỹ', quickClean: 'Quick Add tên chưa vào list bằng dropdown bên dưới', rosterTip: '/la-roster <name> để xem roster đầy đủ của hit cần chú ý', rerunTip: 'Chạy lại với ảnh mới để kiểm tra lại', source: 'NGUỒN db blacklist + whitelist + watchlist + trusted' },
    format: { via: 'via **{name}**', correctedOcr: 'OCR đọc **{input}** → lostark.bible khớp **{name}**', correctedText: 'nhập **{input}** → lostark.bible khớp **{name}**', rosterVia: 'alt roster **{name}**', rosterEntry: 'alt roster **{name}** → entry **{entry}**', alts: 'alts', more: '+{count} tên khác', local: 'Nội bộ', trusted: 'trusted' },
  },
  scan: {
