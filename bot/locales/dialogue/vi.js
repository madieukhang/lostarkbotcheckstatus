export default {
  ...
  check: {
    ...
    format: { via: 'qua **{name}**', correctedOcr: 'OCR đọc **{input}** → lostark.bible khớp **{name}**', correctedText: 'nhập **{input}** → lostark.bible khớp **{name}**', rosterVia: 'alt roster **{name}**', rosterEntry: 'alt roster **{name}** → entry **{entry}**', alts: 'alt', more: '+{count} tên khác', local: 'Nội bộ', trusted: 'trusted' },
  },
  scan: {
