export default {
  ...
  check: {
    ...
    }, imageQueued: 'Đã xếp lượt xử lý ảnh · còn **{count}** lượt phía trước…', imageProgress: 'Đã nhận ảnh · đang đọc **{current}/{count}**…', imageIgnored: 'Mỗi lượt xử lý tối đa {limit} ảnh, nên tớ bỏ qua **{count}** ảnh dư.', ignored: 'Tớ bỏ qua **{count}** {word} dư rồi - mỗi lượt tớ chỉ nhận được {limit} thôi.', nameOne: 'tên', nameMany: 'tên', failed: { title: 'Lượt check chưa xong được', description: 'Tớ lấy được tên ra khỏi ảnh rồi, nhưng đối chiếu với các list thì chưa xong.' }, autoFailed: { title: 'Tớ chưa check xong được cái này', description: 'Nửa chừng thì có gì đó trục trặc. Cậu đăng lại ảnh nhé, tớ thử lần nữa.' },
