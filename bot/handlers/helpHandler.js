...
export async function handleHelpCommand(interaction) {
  ...
  const helpLines = lang === 'vn' ? [
    ...
    '`/la-list enrich tên [deep_limit]` · 🔍 Stronghold deep-scan entry đã có và append alts khám phá được (officer only, ~10-15 phút)',
    ...
    '`/la-list enrich name [deep_limit]` · 🔍 Stronghold deep-scan an existing entry and append discovered alts (officer only, ~10-15 min)',
