...
### Changed
- The blacklist result card shown above `/la-roster` now places **Server** before **CP**. Its inline grid reads `Raid / Added / ilvl` followed by `Server / CP`, while officer detail cards keep `Added by` between those two fields.
