...
- When a Discord shard has neither resumed nor re-identified two minutes after it started reconnecting, the bot exits with code 1 so Railway restarts it, the same recovery the 60-second login watchdog already uses at startup. The reconnect logs also show how long each shard took to come back.
